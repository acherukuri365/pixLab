  ...
  public Picture enhance(int size) {
    ...
    for(int i = 0; i < pixels.length; i++) {
      for(int j = 0; j < pixels[0].length; j++) {
        ...
        newR = 2 * pixel.getRed() - r; if(newR > 255) newR = 255; if(newR < 0) newR = 0;
        newG = 2 * pixel.getGreen() - g; if(newG > 255) newG = 255; if(newG < 0) newG = 0;
        newB = 2 * pixel.getBlue() - b; if(newB > 255) newB = 255; if(newB < 0) newG = 0;
